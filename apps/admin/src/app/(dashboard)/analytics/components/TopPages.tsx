...
export function TopPages({ data }: TopPagesProps) {
  ...
  return (
    <Card className="p-4">
      <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">인기 페이지 TOP 10</h2>
            ...
            <div key={item.path} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span className="truncate text-sm text-gray-700 dark:text-gray-300" title={item.path}>
                    {item.path}
                  </span>
